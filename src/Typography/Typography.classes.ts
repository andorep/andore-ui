...
import { TypographySizes, TypographyVariants } from "./Typography.types.ts";

export const TypographyBaseClassName = "typography-root";

export const TypographyDisplayBaseClassName = "typography-display font-bold";

export const TypographyHeadlineBaseClassName = "typography-heading font-bold";

export const TypographyTitleBaseClassName = "typography-title font-bold";

export const TypographyBodyBaseClassName = "typography-body";
