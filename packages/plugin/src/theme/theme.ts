...
export const theme: Theme = {
    ...
    colors: {
        ...
        surface: {
            ...
            "inverse": getColorFromMaterialColor('neutral', 10),
            "inverse-text": getColorFromMaterialColor('neutral', 90),
            "inverse-primary": getColorFromMaterialColor(primary, 40),
            "dark-dim": getColorFromMaterialColor('stone', 30),
            "dark-inverse": getColorFromMaterialColor('neutral', 90),
            "dark-inverse-text": getColorFromMaterialColor('neutral', 10),
            "dark-inverse-primary": getColorFromMaterialColor(primary, 80),
