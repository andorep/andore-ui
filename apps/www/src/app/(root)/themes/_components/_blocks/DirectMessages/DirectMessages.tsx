...
const readCopyFile = async () => {
    const filePath = path.join(process.cwd(), 'src/app/(root)/themes/_components/_blocks/DirectMessages', "copy.txt");
...
const DirectMessages = async () => {
  ...
  return (
    <Block title={"Direct Messages"} subtitle={"3 new messages"} copyText={copyText}>
      <List>
        <DirectMessageItem>
