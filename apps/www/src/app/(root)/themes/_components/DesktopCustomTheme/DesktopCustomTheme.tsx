...
const DesktopCustomTheme = (props: DesktopCustomThemeProps) => {
    ...
    return (
        <section className="hidden md:flex flex-col w-full h-fit p-4 rounded bg-surface-container-lowest dark:bg-surface-dark-container-lowest border-outline-variant border-solid border">
