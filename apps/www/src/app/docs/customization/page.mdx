...
To maintain a consistent look and feel across the application, this project uses <span className="underline">[Material Design](https://material.io/design)</span> as the design system.
