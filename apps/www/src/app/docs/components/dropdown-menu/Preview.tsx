        ...
        <DropdownMenuPortal>
          <DropdownMenuContent sideOffset={5}>
            <DropdownMenuItem defaultChecked={true}>
              New Tab
              <DropdownMenuItemTrailing>⌘+T</DropdownMenuItemTrailing>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <DropdownMenuItemLeading>
                <svg
              ...
              New Window
              <DropdownMenuItemTrailing>⌘+N</DropdownMenuItemTrailing>
            </DropdownMenuItem>
              ...
              <DropdownMenuPortal>
                <DropdownMenuSubContent sideOffset={2} alignOffset={-5}>
                  <DropdownMenuItem>
                    ...
                    Save Page As…
                    <DropdownMenuItemTrailing>⌘+S</DropdownMenuItemTrailing>
                  </DropdownMenuItem>
            ...
            >
              ...
              Show Bookmarks
              <DropdownMenuItemTrailing>⌘+B</DropdownMenuItemTrailing>
            </DropdownMenuCheckboxItem>
            <DropdownMenuCheckboxItem
              checked={urlsChecked}
            ...
            <DropdownMenuLabel>Radio button</DropdownMenuLabel>
