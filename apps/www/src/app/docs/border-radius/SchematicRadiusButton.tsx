...
const SchematicRadiusButton = () => {
  ...
  return (
    <div className={"w-fit h-fit flex flex-col gap-4"}>
      <Chip ref={refsBackground.setReference}>Click me</Chip>
      <div>
        <Fab icon={<PaintIcon />} ref={refsText.setReference} />
      </div>
      <FloatingPointer
        placement={"left"}
      ...
      >
        <ListItem className={`w-max rounded-full h-fit`}>
          <ListItemText>
            <span className={"font-medium"}>rounded-lg</span>
          </ListItemText>
        </ListItem>
      </FloatingPointer>
    </div>
...
export default SchematicRadiusButton;
