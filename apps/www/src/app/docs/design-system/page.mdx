...
This library provides a set of components that follow the <span className="underline">[Material Design](https://material.io/design)</span> system, which is a design system created by Google.
...
but also end up with responsive that can be changed easily by levering the theme system.
...
All of the tokens used by the design system are based on the <span className="underline">[Material Design](https://material.io/design)</span> system,
so you can refer to the Material Design documentation to understand how these tokens work.
<br/>
In the other hand, you can also refer to the <span className="underline">[Theming](/docs/customization)</span> section to understand how to modify these tokens.
